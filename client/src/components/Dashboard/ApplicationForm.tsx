                            ...
                            <form>
                                ...
                                <Row className="mb-5 text-center">
                                    <Col xs={12} md={4}>
                                        ...
                                        <label htmlFor="ccc" className="label">Credit Commitee Chairperson</label>
                                    </Col>
                                    <Col xs={12} md={4}>
                                        <h5 className="card-title mb-2">TERESITA M. VILLARUEL</h5>
                                        <label htmlFor="treasurer" className="label">Treasurer</label>
                                    </Col>
                                    <Col xs={12} md={4}>
                                        <h5 className="card-title mb-2">HELEN M. AQUINO</h5>
                                        <label htmlFor="chairman" className="label">Chairman</label>
                                    </Col>
                                </Row>

  ...
  return (
    <div style={{display: 'flex',
      ...
      <NavBar />
        ...
        <div className="container d-flex justify-content-center align-items-center text-center" style={{ minHeight: '100vh' }}>
            <div className="row">
                ...
                <img 
                    ...
                    className="img-fluid" 
                    width="300px"
                    style={{ marginBottom: '0.25rem', justifyContent: 'center' }}
                />
                </div>
